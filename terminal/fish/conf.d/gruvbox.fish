...
set -g hydro_color_duration "#a89984" # gruvbox gray - command duration color
set -g hydro_color_start "#689d6a" # gruvbox aqua - start symbol color

# Set fish git prompt colors to gruvbox as well
set -g __fish_git_prompt_color_branch "#458588" # gruvbox blue
set -g __fish_git_prompt_color_dirtystate "#d65d0e" # gruvbox orange
set -g __fish_git_prompt_color_upstream "#b16286" # gruvbox purple
